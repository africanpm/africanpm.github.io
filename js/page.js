...
function landingPage() {
    ...
    const moreTage = `<i style="color:gray; font-weight:500; font-size:smaller"> ...more</i>`;
...
function articleImageLoader() {
    ...
    setTimeout(() => {
        ...
        if (blogPost[randJson].headline != $("#article_header").text().slice(10)) {
            suggestedPage(randJson)
        }

        
        function suggestedPage(randNum) {
